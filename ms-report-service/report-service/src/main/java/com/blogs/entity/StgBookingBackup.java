...
@Setter
@Entity
@Table(name = "StgBookingBackup")
@NamedQuery(name = "StgBookingBackup.findAll", query = "SELECT m FROM StgBookingBackup m")
public class StgBookingBackup extends BaseEntity{
